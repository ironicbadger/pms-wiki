...
Your server will never be "finished". It is a living, breathing manifestation of your tinkering and learning. Infrastructure as Code allows you to track changes made in real-time to the _actual code_ used to deploy your _actual server_.
...
Which one should you use? I get this question a lot. It's true, there is a huge overlap between Ansible and Terraform but they both _excel_ in different areas. So I tend to delineate between two like this.
