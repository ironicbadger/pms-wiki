...
Gitea doesn't have any kind of built-in CI features of the largest self-hosted, open source player in this space, Gitlab. But what is lacks in features it makes up for in small footprint and simplicity. These can instead be handled by external applications such as [drone](https://www.drone.io/).
